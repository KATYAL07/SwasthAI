...
export const HINDI_DICTIONARY: Record<string, string> = {
  ...
  "SwasthAI Differentiators": "SwasthAI डिफरेंशिएटर्स",
  ...
  "All vital trends, symptom telemetry, and pharmaceutical compliance patterns are anonymized and mathematically hashed to your private SwasthAI vault.": "सभी महत्वपूर्ण रुझान, लक्षण टेलीमेट्री, और दवा अनुपालन पैटर्न को आपके निजी SwasthAI वॉल्ट में गुमनाम और गणितीय रूप से हैश किया गया है।",
  "SwasthAI Live Command Center": "SwasthAI लाइव कमांड सेंटर",
  "Active SwasthAI Node": "सक्रिय SwasthAI नोड",
  ...
  "Self (Primary User (SwasthAI User))": "स्वयं (प्राथमिक उपयोगकर्ता)",
  "Self (Primary User)": "स्वयं (प्राथमिक उपयोगकर्ता)",
  "Self": "स्वयं",

  // Hero Card & Copilot
  "Hello, SwasthAI User": "नमस्ते, SwasthAI उपयोगकर्ता",
