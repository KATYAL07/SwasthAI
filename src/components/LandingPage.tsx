      ...
      <div id="landing-page-root" className={`min-h-screen font-sans antialiased overflow-x-hidden transition-colors duration-300 ${
        ...
        >
          <div className="max-w-7xl mx-auto flex items-center justify-between">
            ...
            {/* Quick launch Portal & Auth buttons */}
            <div className="flex items-center gap-3">
              {user ? (
                ...
                <button
                  ...
                  className="text-xs font-semibold px-4 py-2 rounded-full border border-slate-300 text-slate-700 hover:bg-slate-100 transition-colors cursor-pointer"
                >
                  Sign In
                </button>
              )}
              
              <div onClick={() => handleTransitionNavigate("overview_classic")} className="hidden sm:block">
                <InteractiveHoverButton text="Launch SwasthAI" className="w-40 text-xs py-1.5" />
              </div>
